...
class AbstractObject{
    ...
    public:
        ...
        virtual std::vector<std::tuple<unsigned int, unsigned int, unsigned int>> get_faces() const = 0;
        ...
        virtual std::tuple<unsigned int, unsigned int, unsigned int> get_face_at(int location) const = 0;
