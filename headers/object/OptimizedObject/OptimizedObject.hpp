...
class OptimizedObject : public AbstractObject
{
...
public:
    ...
    OptimizedObject(
        ...
        const std::vector<std::tuple<unsigned int, unsigned int, unsigned int>> &faces,
    ...
    std::vector<std::tuple<unsigned int, unsigned int, unsigned int>> get_faces() const override;
    ...
    std::tuple<unsigned int, unsigned int, unsigned int> get_face_at(int location) const override;
