...
/**
 * Concrete implementation of the .obj loader
 */
std::unique_ptr<AbstractLocalObject> ObjLoader::loadObject()
{
    ...
    { // Leggi il file riga per riga
        ...
        { // Faccia
            ...
            this->abstractObjectBuilder->add_face(glm::uvec3(v1,v2,v3));
